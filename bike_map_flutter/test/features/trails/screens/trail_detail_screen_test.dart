  ...
  group('TrailDetailScreen', () {
    testWidgets('should render placeholder with correct title', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: TrailDetailScreen(trailId: 'test-trail-123'),
        ),
      );

      expect(find.text('Trail Detail'), findsOneWidget);
      expect(find.textContaining('Trail Detail Screen - Coming Soon'), findsOneWidget);
    });
    ...
    testWidgets('should display trail ID parameter', (tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: TrailDetailScreen(trailId: testTrailId),
        ),
      );
